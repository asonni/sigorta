              ...
              <CardBody>
                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={require('../../../assets/img/avatars/1.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={require('../../../assets/img/avatars/2.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={require('../../../assets/img/avatars/3.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={require('../../../assets/img/avatars/4.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={require('../../../assets/img/avatars/5.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                        <span className="avatar-status badge-success"></span>
                      </div>
                    </td>
                    <td>
