                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <img
                          src={require('../../../assets/img/flags/India.png')}
                          alt="India"
                          style={{ height: 24 + 'px' }}
                        />
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <img
                          src={require('../../../assets/img/flags/France.png')}
                          alt="France"
                          style={{ height: 24 + 'px' }}
                        />
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <img
                          src={require('../../../assets/img/flags/Spain.png')}
                          alt="Spain"
                          style={{ height: 24 + 'px' }}
                        />
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <img
                          src={require('../../../assets/img/flags/Poland.png')}
                          alt="Poland"
                          style={{ height: 24 + 'px' }}
                        />
                      </td>
